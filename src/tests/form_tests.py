...
class FormTests(unittest.TestCase):
    ...
    def testActualFormsGreek(self):
        ...
        self.assertForm(["hippos", "-arch-", "-ic-character"], "hipparchic")
        self.assertForm(["demos", "-arch-", "-y-passthrough"], "demarchy")
        self.assertForm(["plutos", "-crat/noun", "greek-silent-agent"], "plutocrat")
        self.assertForm(["demos", "-crat/noun", "-ic"], "democratic")
        self.assertForm(["gerontos", "-crat/noun", "-y-passthrough"], "gerontocracy")
        self.assertForm(["arista", "-crat/adj", "greek-silent-agent"], "aristocrat")
        self.assertForm(["arista", "-crat/adj", "-ic"], "aristocratic")
        self.assertForm(["arista", "-crat/adj", "-y-passthrough"], "aristocracy")
        ...
        self.assertForm(["hagia-saint", "-lat-", "greek-silent-agent"], "hagiolater")
        self.assertForm(["angelos", "-lat-", "-y-def"], "angelolatry")
        self.assertForm(["bryon", "-log-/noun", "greek-ist"], "bryologist")
        self.assertForm(["ge", "-log-/noun", "-ic-def"], "geologic")
        self.assertForm(["cosmos", "-log-/noun", "-y-def"], "cosmology")
        self.assertForm(["pyr", "-man-/noun", "-ia-def"], "pyromania")
        self.assertForm(["plutos", "-man-/noun", "-ic-def"], "plutomanic")
        self.assertForm(["autos", "-man-/noun", "-iac-haver"], "automaniac")
        # oman-verb
        ...
        self.assertForm(["aleuron", "-metr-", "greek-silent-agent"], "aleurometer")
        self.assertForm(["astros", "-metr-", "-ic-def"], "astrometric")
        self.assertForm(["ge", "-metr-", "-y-def"], "geometry")
        self.assertForm(["zoon", "-morph", "greek-silent-haver"], "zoomorph")
        self.assertForm(["pais", "-morph", "-ic-def"], "pedomorphic")
        self.assertForm(["plutos", "-nom-/noun", "greek-ist"], "plutonomist")
        self.assertForm(["gastros", "-nom-/noun", "-ic-def"], "gastronomic")
        self.assertForm(["astros", "-nom-/noun", "-y-def"], "astronomy")
        self.assertForm(["copros", "-phag-", "greek-e-agent"], "coprophage")
        self.assertForm(["zoon", "-phag-", "-ic-def"], "zoophagic")
        self.assertForm(["autos", "-phag-", "-y-def"], "autophagy")
        self.assertFormIn(["gyne", "-phil-/noun", "-e-haver"], ["gynophile", "gynecophile"])
        self.assertForm(["hydor", "-phil-/noun", "-ic-def"], "hydrophilic")
        self.assertForm(["necros", "-phil-/noun", "-ia-def"], "necrophilia")
        self.assertForm(["arachne", "-phob-/noun", "-e-haver"], "arachnophobe")
        self.assertForm(["hydor", "-phob-/noun", "-ic-def"], "hydrophobic")
        self.assertForm(["nyx", "-phob-/noun", "-ia-def"], "nyctophobia")
        self.assertForm(["gala", "-phor-", "greek-e-agent"], "galactophore")
        self.assertFormIn(["gyne", "-phor-", "-ic-part"], ["gynophoric", "gynecophoric"])
        self.assertForm(["phallos", "-phor-", "-ia-def"], "phallophoria")
        self.assertForm(["therma-adj", "-pot-/adj", "greek-e-agent"], "thermopote")
        self.assertForm(["crya-adj", "-pot-/adj", "-ic-def"], "cryopotic")
        self.assertForm(["gala", "-pot-/noun", "greek-e-agent"], "galactopote")
        self.assertForm(["hydor", "-pot-/noun", "-ia-def"], "hydropotia")
        self.assertForm(["gala", "-rrhea"], "galactorrhea")
        self.assertForm(["logos", "-rrhea"], "logorrhea")
        self.assertForm(["mikra", "-scop-/adj", "-e-instrument"], "microscope")
        self.assertForm(["makra", "-scop-/adj", "-ic-def"], "macroscopic")
        self.assertForm(["crya-adj", "-scop-/adj", "-y-def"], "cryoscopy")
        self.assertForm(["astros", "-scop-/noun", "-e-instrument"], "astroscope")
        self.assertForm(["hagia-saint", "-scop-/noun", "-ic-def"], "hagioscopic")
        self.assertForm(["autos", "-scop-/noun", "-y-def"], "autoscopy")
