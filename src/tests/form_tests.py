...
class FormTests(unittest.TestCase):
    ...
    def testActualFormsLatin(self):
        ...
        self.assertForm(["apes", "-ine"], "apian")
        self.assertForm(["avis", "-ine"], "avian")
    ...
    def testActualFormsGreek(self):
        ...
        self.assertForm(["ge", "-log-", "-ic-def"], "geologic")
        self.assertForm(["cosmos", "-log-", "-y-def"], "cosmology")
        ...
        self.assertForm(["plutos", "-nom-", "greek-ist"], "plutonomist")
        self.assertForm(["gastros", "-nom-", "-ic-def"], "gastronomic")
        self.assertForm(["astros", "-nom-", "-y-def"], "astronomy")
        ...
        self.assertFormIn(["gyne", "-phil-", "-e-haver"], ["gynophile", "gynecophile"])
        self.assertForm(["hydor", "-phil-", "-ic-def"], "hydrophilic")
        self.assertForm(["necros", "-phil-", "-ia-def"], "necrophilia")
        self.assertForm(["arachne", "-phob-", "-e-haver"], "arachnophobe")
        self.assertForm(["hydor", "-phob-", "-ic-def"], "hydrophobic")
        self.assertForm(["nyx", "-phob-", "-ia-def"], "nyctophobia")
        ...
        self.assertForm(["makra", "-scop-", "-ic-def"], "macroscopic")
        self.assertForm(["crya-adj", "-scop-", "-y-def"], "cryoscopy")
        self.assertForm(["astros", "-scop-", "-e-instrument"], "astroscope")
        self.assertForm(["hagia-saint", "-scop-", "-ic-def"], "hagioscopic")
        self.assertForm(["autos", "-scop-", "-y-def"], "autoscopy")
