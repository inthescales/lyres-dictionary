...
class FormTests(unittest.TestCase):
    ...
    def testActualFormsLatin(self):
        ...
        self.assertForm(["preter-", "natura", "-al"], "preternatural")
    ...
    def testActualFormsGreek(self):
        ...
        self.assertForm(["plutos", "-crat", "greek-silent-agent"], "plutocrat")
        self.assertForm(["demos", "-crat", "-ic"], "democratic")
        self.assertForm(["gerontos", "-crat", "-y-passthrough"], "gerontocracy")
        self.assertForm(["arista", "-crat", "greek-silent-agent"], "aristocrat")
        self.assertForm(["arista", "-crat", "-ic"], "aristocratic")
