...
expression_schema = [
    ...
    ["has-type",                [one_or_more, str]],        # true if the morph's type is equal to the string, or is in the list
    ["has-property",            [str]],                     # true if the morph contains a value for the given property
    ["has-tag",                 [str]],                     # true if the morph contains the given tag
    ["has-all-tags",            [list, str]],               # true if the morph contains all of the given tags
    ["has-any-tags",            [list, str]],               # true if the morph contains any of the given tags
